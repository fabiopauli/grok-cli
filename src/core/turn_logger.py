...
class TurnLogger:
    ...
    def complete_turn(self, summary: Optional[str] = None) -> Turn:
        """
    ...
    def _generate_auto_summary(self) -> str:
        ...
        assistant_messages = len([e for e in self.current_turn.events if e.type == "assistant_message"])
        tool_calls = len([e for e in self.current_turn.events if e.type == "tool_call"])
