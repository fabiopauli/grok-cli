...
class MemoryManager:
    ...
    def get_directory_memories(self, directory: Optional[Path] = None) -> List[Dict[str, Any]]:
        """
    ...
    def change_directory(self, new_directory: Path) -> Dict[str, Any]:
        ...
        has_existing_memories = new_dir_str in self.directory_memories and len(self.directory_memories[new_dir_str]) > 0
    ...
    def clear_directory_memories(self, directory: Optional[Path] = None) -> int:
        """
    ...
    def export_memories(self, include_global: bool = True, include_directory: bool = True) -> Dict[str, Any]:
        """
    ...
    def get_memory_statistics(self) -> Dict[str, Any]:
        ...
        """
        total_directory_memories = sum(len(memories) for memories in self.directory_memories.values())
