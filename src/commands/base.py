...
class CommandRegistry:
    ...
    def execute_command(self, user_input: str, session: GrokSession) -> Optional[CommandResult]:
        """
    ...
    def find_similar_command(self, user_input: str, threshold: int = 70) -> Optional[str]:
        """
