...
class TestConfig:
    ...
    def test_config_initialization(self):
        ...
        assert config.reasoner_model == "grok-4-1-fast-reasoning"
    ...
    def test_model_switching(self):
        ...
        config.set_model("grok-4-1-fast-reasoning")
        assert config.current_model == "grok-4-1-fast-reasoning"
        assert config.is_reasoner is True

        # Test switching back to default
        config.set_model("grok-4-1-fast-non-reasoning")
        assert config.current_model == "grok-4-1-fast-non-reasoning"
    ...
    def test_system_prompt_generation(self):
        ...
        assert "Grok Engineer" in prompt
