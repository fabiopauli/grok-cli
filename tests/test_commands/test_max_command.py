...
class TestMaxContextToggle:
    ...
    def test_toggle_enables_extended_context(self, mock_console):
        ...
        result = command.execute("/max", session)
    ...
    def test_multiple_toggles(self, mock_console):
        ...
        assert session.config.update_extended_context.call_args_list[0][0][0] == True
        ...
        command.execute("/max", session)
        assert session.config.update_extended_context.call_args_list[1][0][0] == False
        ...
        command.execute("/max", session)
        assert session.config.update_extended_context.call_args_list[2][0][0] == True
